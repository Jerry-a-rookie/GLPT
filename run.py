...
def run_experiment(args):
    ...
    Args:
        args (argparse.Namespace): 实验配置参数
    """
...
def run():
    ...
    parser.add_argument('--model_id', type=str, default='Electricity_336_96', help='model id')
    parser.add_argument('--model', type=str, default='GLPT', help='model name')
    ...
    parser.add_argument('--label_len', type=int, default=168, help='start token length')
    ...
    parser.add_argument('--win_size', type=int, default=4, help='win_size')
    ...
    parser.add_argument('--attention_dropout', type=float, default=0.3, help='attention dropout')
